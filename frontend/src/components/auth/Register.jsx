      ...
      >
        ...
        <Box flex="1">
          <VStack spacing={6} align="stretch">
            ...
            <Box>
              <Heading size="2xl" mb={2}>Create Account</Heading>
              <Text color="gray.600">Please fill in the details below</Text>
            </Box>
          ...
          <VStack h="full" justify="center" spacing={8}>
            <Box>
              ...
              <Text
                ...
                textAlign="center"
              >
                Join Tasky to manage your tasks efficiently and boost your productivity...
              </Text>
            </Box>
          </VStack>
        </Box>
